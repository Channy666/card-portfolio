...
const heroCards = [
  ...
  { 
      ...
      rotate: 8,        
      scale: 1.2,      
      img: 'https://raw.githubusercontent.com/Channy666/portfolio/refs/heads/main/AI%E5%9B%BE%E7%89%87-Midjourney-AI%E4%BA%BA%E8%AE%BE%E5%B0%81%E9%9D%A2(4).jpg'
  }, 
  { 
      id: 3, 
      color: '#55FFFF', 
      rotate: 24,       
      scale: 1.15,       
      img: 'https://raw.githubusercontent.com/Channy666/portfolio/refs/heads/main/AI%E5%9B%BE%E7%89%87-Midjourney-AI%E4%BA%BA%E8%AE%BE%E5%B0%81%E9%9D%A2(2).jpg'
  }, 
  {   id: 4, 
      color: '#E0221E', 
      rotate: 12,       
      scale: 1.1,      
      img: 'https://raw.githubusercontent.com/Channy666/portfolio/refs/heads/main/AI%E5%9B%BE%E7%89%87-Midjourney-AI%E4%BA%BA%E8%AE%BE%E5%B0%81%E9%9D%A2(6).jpg'
  }, 
  { 
      id: 5, 
      color: '#E0221E', 
      rotate: 2,      
      scale: 1.0,      
      img: 'https://raw.githubusercontent.com/Channy666/portfolio/refs/heads/main/AI%E5%9B%BE%E7%89%87-Midjourney-AI%E4%BA%BA%E8%AE%BE%E5%B0%81%E9%9D%A2(13).jpg' 
  }, 
  { 
      id: 6, 
      color: '#0044BA', 
      rotate: 15,       
      scale: 0.9,       
      img: 'https://raw.githubusercontent.com/Channy666/portfolio/refs/heads/main/AI%E5%9B%BE%E7%89%87-Midjourney-AI%E4%BA%BA%E8%AE%BE%E5%B0%81%E9%9D%A2(14).jpg'
  },
  { 
      id: 7, 
      color: '#AA88EE', 
      rotate: -15,       
      scale: 0.95,      
      img: 'https://raw.githubusercontent.com/Channy666/portfolio/refs/heads/main/AI%E5%9B%BE%E7%89%87-Midjourney-AI%E4%BA%BA%E8%AE%BE%E5%B0%81%E9%9D%A2(12).jpg'
  },
  { 
      id: 8, 
      color: '#4ECDC4', 
...
const ImageRevealHeroTitle: React.FC = () => {
    ...
    const REVEAL_IMAGE = "https://raw.githubusercontent.com/Channy666/portfolio/refs/heads/main/%E5%B7%A5%E4%BD%9C%E5%9B%BE.jpg";
...
const FloatingHeroCard: React.FC<{ card: any, index: number, hasEntered: boolean }> = ({ card, index, hasEntered }) => {
    ...
    const [isHovered, setIsHovered] = useState(false);
    const [aspectRatio, setAspectRatio] = useState<number | string>('3/4');
                    ...
                    >
                        ...
                        <div className="absolute top-[28%] left-0 w-full text-center pointer-events-none" style={{ transform: `translateZ(${DEPTHS.TEXT}px) rotateX(-10deg)` }}>
                            ...
                            <motion.div 
                                ...
                                viewport={{ once: true }}
                            >
                                <div className="font-albert-light text-2xl md:text-3xl text-gray-500 tracking-widest uppercase">Versatile AI Ops</div>
                                <div className="w-12 h-[1px] bg-gray-300 my-1" />
                                <div className="font-albert-light text-xl md:text-2xl text-gray-400 tracking-widest uppercase">Bridging Tech, Content & Global Markets</div>
                            </motion.div>
                        </div>
